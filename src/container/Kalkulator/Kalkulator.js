        ...
        return (
            <div className="container calculator">
                <div className="form d-flex justify-content-between align-items-center">
                    <Button className="reflesh bg-transparent" onClick={this.reflesh}>
                    <FontAwesomeIcon icon={faRedoAlt} />
                    </Button>
                    <h5 className="fw-bold">Form 1</h5>
                    <div className="icons">
                        <Button className="shadow-none me-1"><FontAwesomeIcon icon={faMinus}/></Button>
                        <Button className="shadow-none "><FontAwesomeIcon icon={faWindowRestore}/></Button>
                        <Button className="shadow-none me-1"><FontAwesomeIcon icon={faTimes}/></Button>
                    </div>
                </div>
